...
(async function () {
    ...
    var ver = new GameVersion_1.GameVersion(MinecraftVersion_1.MinecraftVersion.V1_17_HIGHER, GameTweak_1.GameTweak.VANILLA, "1.18", "1.18.2");
    var vanillaUpdater = new VanillaUpdater_1.VanillaUpdater(ver, dir);
    var forgeUpdater = new ForgeUpdater_1.ForgeUpdater(new ForgeVersion_1.ForgeVersion(ver.versionManisfest, "40.0.12"), dir);
